$(document).ready(function () {
	...
	$("#selectFilterMonth").change(function(){
	  ...
	  //concluidas
			...
			url: "/../jezzy-portal/saleReport/getAllSalesByMonthComplete",
			success: function(result){	
				
			console.log(result);
			$("#tableAllSalesDone").html(result);
			$(".month-loading").fadeOut(200);
	    ...
	    //pendentes
			...
			url: "/../jezzy-portal/saleReport/getAllSalesByMonthPendentes",
			success: function(result){	
				
			console.log(result);
			$("#tableAllSalesPending").html(result);
			$(".month-loading").fadeOut(200);
