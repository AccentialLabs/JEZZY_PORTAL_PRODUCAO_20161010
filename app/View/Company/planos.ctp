					...
					<div class="form-group">
					 ...
					 <div class="item-plano pull-left" >
					  ...
					  <div class="plano-header" >
							...
							<div class="almost-jumbotron">
							<ul>
								<li>Experimente o Jezzy por 15 dias grátis<!/li>
								<li>Todas as funcionalidades descritas no plano STANDARD</li>
							</ul>
						</div>
						<div class="plano-valor" >
<h4>Grátis por 15 dias <br/><small class="plano-small">Após o período de 15 dias, será necessário escolher um plano de assinatura</small></h4>
						</div>
						<div class="text-center">
