...
<?php echo $this->Html->script('View/SelectPlan'); ?>

<div class="modal fade" id="myModalPlans" role="dialog"  data-backdrop="static">
			  ...
			  <div class="modal-content">
				<div class="modal-header" style="padding:20px 50px;">
				 <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
				  <h4>Seu período de TRIAL expirou!<br/> Escolha o seu plano JEZZY para continuar:</h4>
				</div>
					...
					<div class="form-group">
					 ...
					 <div class=" pull-left col-md-6" >
						...
						<div class="almost-jumbotron">
							...
							<h4>R$149,80 <small class="plano-small"><br>Debitados mensalmente no Cartão de Crédito<br /></small></h4>
						</div>
				...
				<div class="modal-footer text-right">
				  <button type="reset" class="btn btn-default btn-default" data-dismiss="modal" id="cancelPlansBtn" style="background: transparent; border: 0px;"><small><span class="glyphicon glyphicon-remove"></span> <small>Não desejo assinar</small></small></button>
		  ...
		  <div class="modal fade" id="myModalCard" role="dialog"  data-backdrop="static">
		  ...
		  <!--<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalCancelPlans">Open Modal</button> -->
		  
		  <!--  MODAL MENSAGEM CASO USUARIO QUEIRA CANCELAR -->
		  <div class="modal fade" id="myModalCancelPlans" role="dialog" data-backdrop="static">
			<div class="modal-dialog modal-md">
			  ...
			  <div class="modal-content">
				<div class="modal-header" style="padding:20px 50px;">
				 <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
				  <h4>Você escolheu não renovar?!...</h4>
				</div>
				<div class="modal-body" style="padding:15px 50px;">
				<di>
				<p>
				Estamos trabalhando para deixar tudo certinho e fazer você e seus clientes terem a melhor experiência com nossa plataforma.<br/>
				Se alguma coisa não funciona como espera, conte para nós, assim podemos continuar melhorando nosso produto e nossos serviços:<br/><br/>
				<textarea class="form-control" rows="4" id="dropoutDescription"></textarea>
				</p>
				 </div>
				<div class="modal-footer text-right">
				  <button type="reset" class="btn btn-default btn-default" data-dismiss="modal" id="cancelModalDropout" style="background: transparent; border: 0px;"><small><span class="glyphicon glyphicon-remove"></span> <small>Continuar cancelamento</small></small></button>
				  <button type="button" class="btn btn-default btn-success" data-dismiss="modal" id="btnNotDropout">Não, mudei de idéia</button>
				</div>
			  </div>
